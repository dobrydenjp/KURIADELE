        ...
        <p class='body'>
            ...
            <table class='container-fluid list table col-lg-6 col-6'>
                <div class='row'> 
                    <tbody>
                        <tr>
                            <th class='top_c'>お名前</th><td><h6><?= $login_customer->name ?></h6></td>
                        </tr>
                        <tr>
                            <th class='top_c'>カタカナ</th><td><h6><?= $login_customer->kana_name ?></h6></td>
                        </tr>
                        <tr>
                            <th class='top_c'>郵便番号</th><td><h6><?= $login_customer->postal_code ?></h6></td>
                        </tr>
                        <tr>
                            <th class='top_c'>住所</th><td><h6><?= $login_customer->address ?></h6></td>
                        </tr>
                        <tr>
                            <th class='top_c'>お電話番号</th><td><h6><?= $login_customer->tel ?></h6></td>
                        </tr>
                    </tbody>
                </div>
            </table>
